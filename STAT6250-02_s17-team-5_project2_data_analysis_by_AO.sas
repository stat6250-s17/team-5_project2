...
[Number of Observations]1142660              

[Number of Features] 13[Data Source]http://www3.cde.ca.gov/download/dq/StaffAssign14.zip
...
[Number of Observations]2981687                

[Number of Features] 23[Data Source]http://www3.cde.ca.gov/download/dq/CourseEnroll14.zip
...
[Number of Observations]1638659              

[Number of Features] 23[Data Source]http://www3.cde.ca.gov/download/dq/ClassEnrollment14.zip

[Data Dictionary]http://www.cde.ca.gov/ds/sd/df/fsclassenroll.asp

[Unique ID Schema] “DistrictCode, Schoolcode, ClassID, Coursecode, ClassCourseID” are all form a Primary key, a unique ID.

[Research Question 1] What ethnicity dominates AP classes? (Rationale: This determines whether minority students are often excluded from these classes) 

[Research Question 2] How many fully-credentialed teachers teach in mostly minority-enrollment schools? (Rationale: This determines whether minority-enrollment schools have the same access to qualified teachers.) 

[Research Question 3] Which students end up in low-level math classes? (Rationale: This would determine if students all have fair access to math pathwasy.) 

[Reason for Choice] There are many issues involving ethnicity and socio-economic access to higher-level coursework.
*